...
SVC_NAME="actions.runner.Akshat453-EvalAI-Starters.Akshats-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Akshat453-EvalAI-Starters.Akshats-MacBook-Air)"
